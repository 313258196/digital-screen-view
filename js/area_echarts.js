    ...
    "features": [
        {
            ...
            "properties": {
                "name": "水南街道",
                "center": [117.97506917138234, 28.42791905181966]
            }
        },
        {
            "type": "Feature",
...
$(function () {
    ...
    function convertData(arrs) {
        ...
        var valuess = [100, 300, 200, 500, 211, 203, 305, 406, 406];
        for (var i = 0; i < arrs.length; i++) {
            if (arrs[i].properties.name == '北门街道') {
                markdata.push({
                    coord: [
                        117.93913417139707,
                        28.43989880405777
    ...
    function map1() {
        ...
        // $.get('./js/xinzhouqu.json', function (usaJson) {

        markdata = convertData(geoJson.features)
